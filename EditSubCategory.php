                        ...
                        <div class="form-group">
                          ...
                          <select>
    										...
    										<div class="form-group">
    											...
    											<div class="col-sm-5">
    											<input type="text" placeholder="Enter SubCategory" value="<?php echo $cat; ?>" id="txt_Category"  name="txt_Category" Required class="form-control">
    											</div>
    										</div>
...
if(isset($_POST["add"]))
{
 ...
 $cat=$conn->real_escape_string($_POST["txt_Category"]);
  $offer=$conn->real_escape_string($_POST["txt_offer"]);
...
$sql="update category set SubCat_Name='$cat' and cat_id='$catid'";
}
else if ($_FILES['file_image1']['name'] != "" && $_FILES['file_image2']['name']=="" ) {
  $sql="update category set SubCat_Name='$cat' ,SubCat_pic1='$filepath' where Subcat_id='$catid'";
}
else if ($_FILES['file_image1']['name'] != "" && $_FILES['file_image2']['name']!="" ) {
  $sql="update category set SubCat_Name='$cat' , SubCat_pic1='$filepath',SubCat_pic2='$filepath1' where Subcat_id='$catid'";
}
echo $sql;
...
//  echo '<script> setTimeout(window.location.href="http:SubCategory.php",1500)</script>';
    //echo "<script> setTimeout(location.href='SubCategory.php',2000);; </script>";
}
else {
