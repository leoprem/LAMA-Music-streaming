...
// Costumers class
require_once BASE_PATH . '/lib/lama_users/Users.php';
$user = new Users();
...
$db = getDbInstance();
$select = array('id', 'username', 'firstname', 'lastname', 'email','status');
...
<!--
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_user.php?operation=create" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Add new</a>
            </div>
        </div>
-->
    </div>
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_user.php?user_id=<?php echo $row['id']; ?>&operation=edit" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
            ...
            <div class="modal fade" id="confirm-delete-<?php echo $row['id']; ?>" role="dialog">
                <div class="modal-dialog">
                    <form action="delete_lama_user.php" method="POST">
                        <!-- Modal content -->
